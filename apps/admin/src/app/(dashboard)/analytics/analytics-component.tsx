...
import { getMostActiveUsers, getTypeSplit, getUserGrowthData, getVolumeData } from "@/lib/helpers";
...
// 2. Monthly Volume
export function MonthlyVolumeChart({ transactions }: { transactions: Transaction[] }) {
...
// 3. Type Split
export function TransactionTypeSplit({ transactions }: { transactions: Transaction[] }) {
...
export function MostActiveUsers({ users, transactions }: { users: Profile[], transactions: Transaction[] }) {
